                ...
                <tr>
                   <td style="width:100px;">
                        ...
                        if ($exercise['start_pic'] != null) {
                            ...
                            echo $this->Html->image($url.'/img/files/'. $exercise['start_pic'], array('width' => 100, 'height' => 100));
                        } else {
                   ...
                   <td style="width:100px;">
                        ...
                        if ($exercise['end_pic'] != null) {
                            ...
                            echo $this->Html->image($url.'/img/files/'. $exercise['end_pic'], array('width' => 100, 'height' => 100));
                        } else {
                            echo "no image available";
                        }
                        ?>&nbsp;</td>
