                ...
                <tr>
                   <td style="width:100px;">
                        ...
                        if ($exercise['start_pic'] != null) {
                            ...
                            echo $this->Html->image('http://localhost:8888/lifestylebreakthrough/imgfiles/' . $exercise['start_pic'], array('width' => 100, 'height' => 100));
                        } else {
                   ...
                   <td style="width:100px;">
                        ...
                        if ($exercise['end_pic'] != null) {
                            ...
                            echo $this->Html->image('http://localhost:8888/lifestylebreakthrough/imgfiles/' . $exercise['end_pic'], array('width' => 100, 'height' => 100));
                        } else {
                            echo "no image available";
                        }
                        ?>&nbsp;</td>
                    ...
                    <td>
                        <table>
                            <tr>
                                <th></th>
                                <th width="100px">Week 1</th>
                                <th width="100px">Week 2</th>
                                <th width="100px">Week 3</th>
                                <th width="100px">Week 4</th>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <table border ="1" width="100px" style ="text-align: center;">
                                    <tr>
                                        <td>
                                           <?php echo __($exercisesPrograms[$i - 1]['exercises_programs']['rec_sets'] ." x " . $exercisesPrograms[$i - 1]['exercises_programs']['rec_reps'] )?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <?php echo __($exercisesPrograms[$i - 1]['exercises_programs']['rec_res'] . " secs"); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <?php echo __($exercisesPrograms[$i - 1]['exercises_programs']['rec_load']. " kgs"); ?>
                                        </td>
                                    </tr>
                                    </table>
                                </td>
