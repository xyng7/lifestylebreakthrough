        ...
        <?php foreach ($newsletters as $newsletter): ?>
            <tr>
                ...
                <td>
                    ...
                    <?php echo $this->Form->postLink(__('Send'), array('action' => 'send', $newsletter['Newsletter']['id']), null, __('Are you sure you want to send newsletter?', $newsletter['Newsletter']['title'])); ?>
