            ...
            <tr>
                <td>        
                    ...
                    if ($exercise['Exercise']['start_pic'] != null) {
                        ...
                        echo $this->Html->image('../imgfiles/' . $exercise['Exercise']['start_pic'], array('width' => 220, 'height' => 220));
                    } else {
                ...
                <td><?php
                    if ($exercise['Exercise']['end_pic'] != null) {
                        //echo $instruction['image']."<br /><br />"; 
                        echo $this->Html->image('../imgfiles/' . $exercise['Exercise']['end_pic'], array('width' => 220, 'height' => 220));
                    } else {
                        echo "no image available";
                    }
                    ?>&nbsp;</td>
...
<?php if (!empty($exercise['BodyPart'])): ?>
                <table cellpadding = "0" cellspacing = "0">
                    ...
                    <tr><td><?php foreach ($exercise['BodyPart'] as $bodyPart): ?>

                        <li><?php echo $bodyPart['body_part']; ?></li>

    <?php endforeach; ?></td>
                    <td> <?php foreach ($exercise['Category'] as $category): ?>
